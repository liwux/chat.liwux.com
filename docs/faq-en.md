...
2. When deploying the project, set the environment variable CODE (supports multiple passwords, separated by commas). After setting the access password, users need to enter the access password in the settings page to use it. See [related instructions](https://oss.k3.work/liwux/zanshangma.jpg#access-password)

## Why doesn't the version I deployed have streaming response
> Related discussion: [#386](https://oss.k3.work/liwux/zanshangma.jpg/issues/386)
...
Please refer to: [#371](https://oss.k3.work/liwux/zanshangma.jpg/issues/371)

## Why is my Token consumed so fast?
> Related discussion: [#518](https://oss.k3.work/liwux/zanshangma.jpg/issues/518)
